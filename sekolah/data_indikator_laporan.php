      ...
      <div class="wrapper">
         ...
         <div class="content-wrapper">
            ...
            <section class="content-header">
               <h1>
                  Dashboard
                  <small>Data Indikator Laporan</small>
               </h1>
               <ol class="breadcrumb">
                  <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
                  <li class="active">Data Indikator Laporan</li>
               </ol>
            </section>
            <!-- Main content -->
            <section class="content">
                <div class="box box-success">
                  <div class="box-header with-border">
                    <h3 class="box-title">Data Indikator Laporan</h3>
              ...
              <div class="modal-content">
                ...
                <div class="modal-body">
                  <div class="form-group">
                    <label for="uraian_indikator_laporan">Uraian Indikator Laporan </label>
                    <input type="text" class="form-control" id="uraian_indikator_laporan" name="uraian_indikator_laporan" placeholder="Uraian Indikator Laporan" required>
                  </div>
                </div>
      ...
      <script>
        $(document).ready(function() {
           var listdata = $('#listdata').DataTable({
                "processing": true,
                "ajax": "data_indikator_laporan/aksi.php?aksi=view_data",
                stateSave: true,
                "order": []
            });
            $('#formtambahdata').on('submit', function() {
                ...
                $.ajax({
                    type: "POST",
                    url: "data_indikator_laporan/aksi.php?aksi=simpan",
                    beforeSend: function() {
                        Swal.fire({
                            title: 'Menunggu',
                            html: 'Memproses data',
            ...
            $('#listdata').on('click', '.ubah-data', function() {
                ...
                $.ajax({
                    type: "post",
                    url: "data_indikator_laporan/modal_edit.php",
                    beforeSend: function() {
                        Swal.fire({
                            title: 'Menunggu',
                            html: 'Memproses data',
                    ...
                    success: function(data) {
                        ...
                        $('#formubahdata').on('submit', function() {
                            ...
                            $.ajax({
                                type: "post",
                                url: "data_indikator_laporan/aksi.php?aksi=edit",
                                beforeSend: function() {
                                    Swal.fire({
                                        title: 'Menunggu',
                                        html: 'Memproses data',
            ...
            $('#listdata').on('click', '.hapus-data', function() {
                ...
                Swal.fire({
                    ...
                    if (result.value) {
                        $.ajax({
                            url: "data_indikator_laporan/aksi.php?aksi=hapus",
                            method: "post",
                            beforeSend: function() {
                                Swal.fire({
                                    title: 'Menunggu',
