...
switch ($_GET['aksi'])
{
    ...
    case 'simpan':
        ...
        $sql = "INSERT INTO  tbl_subindikator_laporan (id_indikator_laporan,uraian_subindikator_laporan) VALUES ('$id_indikator_laporan','$uraian_subindikator_laporan')";
        $query = $connect->query($sql);        
        $connect->close();
    ...
    case 'edit':
            ...
            $uraian_subindikator_laporan=$_POST['uraian_subindikator_laporan'];
            $id_indikator_laporan=$_POST['id_subindikator_laporan'];
           

            $sql = "UPDATE tbl_subindikator_laporan SET id_subindikator_laporan='$id_subindikator_laporan',uraian_subindikator_laporan='$uraian_subindikator_laporan' WHERE id_subindikator_laporan = $id";
