 <table id="isidata" class="table table-bordered">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        <?php echo
        "<a href='#' class='btn btn-info btn-sm ubah-data' data-toggle='modal'  data-id=".$dss['id_dlaporan']." data-original-title='Edit'> <i class='fa fa-edit'></i> </a>".' '."<a href='#' class='btn btn-primary btn-sm hapus-data' data-toggle='modal' data-id=".$dss['id_dlaporan']." data-original-title='Hapus'> <i class='fa fa-close'></i> </a>";
        ?>
      </td>
    </tr>
  <?php }?>
