...
<html>
    <head>
        ...
        <title>Login Sekolah | APLIKASI LAPORAN KINERJA</title>
    ...
    <body class="hold-transition login-page">
        <div class="login-box">
            <div class="login-logo">
                <a href="#"> <b>Login </b>Admin Sekolah </a>
            </div>
            <!-- /.login-logo -->
            <div class="login-box-body">
                ...
                <br />
               <a href="#" class="text-center">Apabila belum memiliki Username dan Password Silahkan Menghubungi Admin Dinas Pendidikan </a>
            </div>
            <!-- /.login-box-body -->
        </div>
        <!-- /.login-box -->
                        ...
                        success: function(json) {
                            ...
                            if (json.status == 1) {
                                 Swal.fire({
                                    icon: 'error',
                                    title: 'NPSN Salah',
                                    text: 'Maaf NPSN Salah Salah/Tidak Terdaftar'
                                });
                            }
                        }
                    });
