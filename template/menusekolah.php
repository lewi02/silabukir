<header class="main-header">
            ...
            <a href="index.php" class="logo">
               ...
               <span class="logo-lg"><b>Admin</b>Sekolah</span>
            </a>
               ...
               <div class="navbar-custom-menu">
                  <ul class="nav navbar-nav">
                     ...
                     <li class="dropdown user user-menu">
                        ...
                        <span class="hidden-xs"><?php echo $_SESSION['nama_sekolah'];?></span>
                        </a>
                        <ul class="dropdown-menu">
                           ...
                           <li class="user-header">
                              ...
                              <p>
                                 <?php echo $_SESSION['npsn'];?> - <?php echo $_SESSION['nama_sekolah'];?>
            ...
            <section class="sidebar">
               ...
               <div class="user-panel">
                  ...
                  <div class="pull-left info">
                     <p><?php echo $_SESSION['nama_sekolah'];?></p>
               ...
               <ul class="sidebar-menu" data-widget="tree">
                  ...
                  <li>
                     ...
                     <i class="fa fa-laptop"></i> <span>Data Guru</span>
                     <span class="pull-right-container">                     
                     </span>
                     </a>
                  </li>                  
