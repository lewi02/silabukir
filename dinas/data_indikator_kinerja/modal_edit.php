...
<div class="modal-body">
    <div class="form-group">
        ...
        <input type="text" class="form-control" id="uraian_indikator_kinerja" name="uraian_indikator_kinerja" value="<?php echo $datpil['uraian_indikator_kinerja'];?>" required>
         <input type="hidden" class="form-control" id="id_indikator_kinerja" name="id_indikator_kinerja" value="<?php echo $datpil['id_indikator_kinerja'];?>"readonly>
    </div>
</div>
