      ...
      <script>
        $(document).ready(function() {
           var listdata = $('#listdata').DataTable({
                "processing": true,
                "ajax": "data_guru/aksi.php?aksi=view_data",
                stateSave: true,
                "order": []
            });
            $('#formtambahdata').on('submit', function() {
                ...
                $.ajax({
                    type: "POST",
                    url: "data_guru/aksi.php?aksi=simpan",
                    beforeSend: function() {
                        Swal.fire({
                            title: 'Menunggu',
                            html: 'Memproses data',
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        $('#formubahdata').on('submit', function() {
                            ...
                            $.ajax({
                                type: "post",
                                url: "data_guru/aksi.php?aksi=edit",
                                beforeSend: function() {
                                    Swal.fire({
                                        title: 'Menunggu',
                                        html: 'Memproses data',
            ...
            $('#listdata').on('click', '.hapus-data', function() {
                ...
                Swal.fire({
                    ...
                    if (result.value) {
                        $.ajax({
                            url: "data_guru/aksi.php?aksi=hapus",
                            method: "post",
                            beforeSend: function() {
                                Swal.fire({
                                    title: 'Menunggu',
