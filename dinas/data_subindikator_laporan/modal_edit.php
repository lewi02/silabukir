...
<div class="modal-body">
    ...
    <div class="form-group">
        <label for="id_indikator_laporan">id_indikator_laporan</label>
    ...
    <div class="form-group">
      ...
      <div class="form-group">
        ...
        <input type="text" class="form-control" id="satuan" name="satuan" value="<?php echo $datpil['satuan'];?>"  placeholder="Satuan" required>
      </div>
      <div class="form-group">
