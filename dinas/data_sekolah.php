              ...
              <div class="modal-content">
                ...
                <div class="modal-body">
                  <div class="form-group">
                    ...
                    <input type="number" class="form-control" id="npsn" name="npsn" placeholder="NPSN" required>
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="alamat_sekolah" name="alamat_sekolah" placeholder="Alamat Sekolah" required>
                  </div>
                  <div class="form-group">
                    <label for="telp_sekolah">Telp Sekolah</label>
                    <input type="number" class="form-control" id="telp_sekolah" name="telp_sekolah" placeholder="Tel Sekolah" required>
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="nama_kepala_sekolah" name="nama_kepala_sekolah"  placeholder="Nama Kepala Sekolah" required>
                  </div>

                  <div class="form-group">
                    <label for="password_sekolah">Password</label>
                    <input type="text" class="form-control" id="password_sekolah" name="password_sekolah" placeholder="Password" required="">
                  </div>
